#!/usr/bin/env python3
"""
WNBA Showdown Lineup Optimizer

This module provides functionality for optimizing WNBA Showdown lineups.
WNBA Showdown contests require 1 Captain and 5 Utility players.
The salary cap for lineups is $50,000.
"""
