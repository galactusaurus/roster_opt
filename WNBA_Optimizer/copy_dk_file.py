#!/usr/bin/env python3
"""
Utility to find and copy the latest DraftKings salaries file to the WNBA_Optimizer directory.
This makes it easier to find and use the latest salaries file for WNBA contests.
"""
...
def main():
    ...
    if not latest_file:
        ...
        print("Please download the DraftKings WNBA salaries CSV file first.")
        return
    ...
    try:
        ...
        print("Ready to run WNBA optimizer!")
