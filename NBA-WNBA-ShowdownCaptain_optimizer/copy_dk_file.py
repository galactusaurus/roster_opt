#!/usr/bin/env python3
"""
Utility to find and copy the latest DraftKings salaries file to the NBA-WNBA-ShowdownCaptain_optimizer directory.
This makes it easier to find and use the latest salaries file for NBA/WNBA Showdown Captain contests.
"""
...
def main():
    ...
    if not latest_file:
        ...
        print("Please download the DraftKings NBA/WNBA Showdown Captain salaries CSV file first.")
        return
    ...
    try:
        ...
        print("Ready to run NBA/WNBA Showdown Captain optimizer!")
