...
This module provides functionality for optimizing NBA/WNBA lineups.
...
class WNBAShowdownOptimizer:
    """Optimizer for NBA/WNBA Basketball contests (currently optimized for WNBA Showdown format)."""
    
    def __init__(self, data_file, salary_cap=50000, captain_multiplier=1.5):
        """
        Initialize the NBA/WNBA Basketball lineup optimizer.
    ...
    def optimize(self, num_lineups=1, player_diversity=3, exposure_constraints=None):
        ...
        for i in range(num_lineups):
            ...
            prob = LpProblem(f"NBA_WNBA_Lineup_{i+1}", LpMaximize)
